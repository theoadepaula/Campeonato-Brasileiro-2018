remDr$navigate("https://www.cartolafcbrasil.com.br/scouts/cartola-fc-2018/rodada-20")
...
write.csv(cb,"CSV/camp_bras_rodada_20_bruto.csv",fileEncoding = 'ISO-8859-1')
write.csv(cb1,"CSV/camp_bras_rodada_20_semi_bruto.csv",fileEncoding = 'ISO-8859-1')
write.csv(cb2,"CSV/camp_bras_rodada_20_final.csv",fileEncoding = 'ISO-8859-1')
